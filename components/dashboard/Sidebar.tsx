    ...
    <aside className="w-64 bg-blue-800 text-white min-h-screen p-4">
      <div className="mb-8">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <span className="font-semibold">Propeller Admin</span>
        </div>
      </div>
      ...
      <nav className="space-y-2">
        ...
        <Link 
          href="/users" 
          className={`flex items-center space-x-3 p-3 rounded-lg ${
            pathname === "/users" ? "bg-blue-700" : "hover:bg-blue-700"
          }`}
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
        ...
        <a href="#" className="flex items-center space-x-3 p-3 hover:bg-blue-700 rounded-lg">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#" className="flex items-center space-x-3 p-3 hover:bg-blue-700 rounded-lg">
          ...
          <span>Third Party Elements</span>
        </a>
        <a href="#" className="flex items-center space-x-3 p-3 hover:bg-blue-700 rounded-lg">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
